		...
		<div class="main">
			...
			<div class="filter-Section">
				...
				<div class="filter-container">
					...
					<span class="seperator"></span>
					<span class="filter-option active" onclick="location.href='cancleList.do';">취소된 예약</span>
				</div><!-- 조회옵션 끝 -->
			</div><!-- 필터 섹션 끝 -->
			<!-- 전체 리스트 -->
				...
				<c:if test="${userId eq bookingsList.user_id}">
					<div class="booking-list">
						<div class="list-header">
							...
							<div class="list-header-right">취소일: ${bookingsList.booking_date}</div>
						</div><!-- list header 끝 -->
						<!-- 호텔정보 카드 섹션 -->
								...
								<div class="info-container">
									<ul>
										...
										<li style="color:#32a923; margin-left: 19px;">
											...
											<span>취소일: ${bookingsList.booking_date}</span>
										</li>
									</ul>
